...
<div class="container-fluid">
        ...
        <div class="col-md-6 cuadro_intro_hover" style="border-right: 1px #1C2B39 solid; border-bottom: 1px #1C2B39 solid;">
            ...
            <div class="caption">
                ...
                <div class="col-md-12 caption-text">
                    <h3>Let your business fly</h3>
                    <p>Located strategically at Luther plaza, we offer furnished office solutions for as short as a day and as long as a year!</p>
    ...
    <div class="row" style="margin-top: 1%;">
        <div class="col-md-offset-1 col-md-10 blogShort">
            <h1 class="text-aviators">Serviced offices</h1>
            ...
            <article>
                ...
                <a href="{{ url('serviced-offices') }}" class="btn btn-info btn-sm">Find out more</a>
            </article>
        </div>
        <div class="col-md-offset-1 col-md-10 blogShort">
            <h1 class="text-aviators">Virtual offices</h1>
            ...
            <article>
                ...
                <a href="{{ url('virtual-offices') }}" class="btn btn-info btn-sm">Find out more</a>
            </article>
        </div>

        <div class="col-md-offset-1 col-md-10 blogShort">
            <h1 class="text-aviators">Meeting and boardroom</h1>
            ...
            <article>
                ...
                <a href="{{ url('meeting-and-boardroom') }}" class="btn btn-info btn-sm">Find out more</a>
            </article>
        </div>
    </div>
