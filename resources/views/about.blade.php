...
<div class="container about ">
    ...
    <div class="col-md-4">
        ...
        <p>We are a leading provider of flexible office solutions, virtual offices,
            ...
            We deliver serviced office space solutions and our range of products are tailored towards our clients needs,
...
<div class="container-fluid about_us">
    <div class="us">
    <h1 class="lead" style="font-size: xx-large;"> What they say about Us</h1>
        <p class="lead">Whatever your business,Whatever your budget, we help your business fly</p>
    </div>
    <div class="testimony">
        <div class="lady">
            <img src="{{asset('images/lady.jpg')}}" height="158px" width="159px">
    ...
    <div class="gent">
        <img src="{{asset('images/gent.jpg')}}" height="158px" width="159px">
        <p>We had an infrastructure project in Kenya and needs a liasim office,
            Aviators  gave us  solutions. Asante</p>
